 ...
 */
public class AnranServiceApacheHttpImpl extends BaseServiceImpl {
    private static Logger logger = LoggerFactory.getLogger(AnranServiceApacheHttpImpl.class);
        ...
        try {
            ...
            try (CloseableHttpClient httpClient = httpClientBuilder.build()) {
                try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                    ...
                    anranApiData.set(new AnranApiData(url, requestStr, responseData, null));
                    return bytes;
                }
            } finally {
    ...
    public String post(String url, Map<String, Object> params) throws AnranException {
        String requestStr = AnranServiceApacheHttpImpl.getUrlParams(params);
        try {
            HttpClientBuilder httpClientBuilder = this.createHttpClientBuilder();
    ...
    private HttpClientBuilder createHttpClientBuilder() throws AnranException {
